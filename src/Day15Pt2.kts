...
fun bfs(map: MutableMap<Coord, TILE>, pos: Coord): MutableMap<Coord, Int> {
...
val positionOxygen = map.filter { it.value == TILE.O2_SYS }.keys.first()

val steps = bfs(map, positionOxygen)

val result = steps.values.max()
